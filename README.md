...
Spring Data JDBC with jOOQ demonstrates how to access a database with jOOQ in combination with Spring Data JDBC.
The domain model is based on Q&A Board example.
